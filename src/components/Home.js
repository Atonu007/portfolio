        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          ...
          <div className='mr-8 md:ml-8'>
            ...
            <p className="mt-4 font-medium ">
              Hi, I'm Atonu proshad Shaha. A passionate <br />
              Front-End React Developer.
            </p>
            <div className="mt-3">
              <a className="text-2xl mr-3" href="mailto:aproshadshaha@gmail.com" target="_blank" rel="noreferrer">
                <i className="uil uil-envelope-alt"></i>
              </a>
              <a className="text-2xl mr-3" href="https://github.com/Atonu007" target="_blank" rel="noreferrer">
                <i className="uil uil-github"></i>
              </a>
              <a className="text-2xl" href="https://www.linkedin.com/in/atonu-proshad-shaha/" target="_blank" rel="noreferrer">
