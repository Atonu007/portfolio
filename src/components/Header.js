...
export const Header = () => {
    const links = [
      ...
      return (
        <>
          <div className={`flex justify-between items-center w-full h-16 px-4 border-b border-gray-300 bg-white z-10 md:fixed relative top-0 left-0`}>
            <div>
              <h1 className='text-xl font-bold ml-2 cursor-pointer hover:scale-110 duration-200'>Atonu</h1>
            </div>
